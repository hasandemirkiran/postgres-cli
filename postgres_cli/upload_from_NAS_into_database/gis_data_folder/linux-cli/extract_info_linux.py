...
def get_data_geoJson(
    ...
    for x in label_table_label_area_EPSG3857:
        ...
        x_max = x[2]
        y_max = x[3]
        # points_tuple = ((x_min, y_min),(x_max, y_max),(x_max, y_max),(x_max, y_min),(x_min, y_min))
        point_to_add = []
        for pt in transformer.itransform([(x_min, y_min), (x_max, y_max)]):
            point_to_add.append(pt[1])
            point_to_add.append(pt[0])
        label_table_label_area_EPSG4326.append(point_to_add)
    # do now swich original one, like 0,2,1,3. Only swich transformed standart
    label_table_label_area_EPSG3857 = [
        box(x[0], x[1], x[2], x[3]) for x in label_table_label_area_EPSG3857
    ]
    label_table_label_area_EPSG4326 = [
...
def pick_all_geojson():
    label_last = {
        "ArenbergMeppen": {
            "Engelbertswald": [
                (
                    "/mnt/nas/gis_data/customers/ArenbergMeppen/Engelbertswald/image_processing_data/labels/Label__ArenbergMeppen__Engelbertswald__2021_10_26__Hasan__v1_TRAININGLABELS.geojson",
                    1442470281,
                )
            ]
        },
        "Blauwald": {
            "Duttenstein": [
                (
                    "/mnt/nas/gis_data/customers/Blauwald/Duttenstein/image_processing_data/labels/Label__Duttenstein__david__v1.geojson",
                    1514098108,
                ),
                (
                    "/mnt/nas/gis_data/customers/Blauwald/Duttenstein/image_processing_data/labels/Label__Duttenstein__felix__v1.geojson",
                    1514098108,
                ),
                (
        ...
        "CenterForst": {
            "Immergruen": [
                (
                    "/mnt/nas/gis_data/customers/CenterForst/Immergruen/image_processing_data/labels/Label__Immergruen__felix__fixed__v1.geojson",
                    542896300,
                )
            ]
        },
        "Fugger": {
            "Wellenburg": [
                (
                    "/mnt/nas/gis_data/customers/Fugger/Wellenburg/image_processing_data/labels/Label__Wellenburg__incl_fir__v2.geojson",
                    865897005,
                )
            ]
        },
        "GrafSpreti": {
            "Lotzbeck": [
                (
                    "/mnt/nas/gis_data/customers/GrafSpreti/Lotzbeck/image_processing_data/labels/Label__Lotzbeck_1__luca__v1.geojson",
                    1257217749,
                ),
                (
                    "/mnt/nas/gis_data/customers/GrafSpreti/Lotzbeck/image_processing_data/labels/Label__Lotzbeck_2__luca__v1.geojson",
                    1417803468,
                ),
                (
                    "/mnt/nas/gis_data/customers/GrafSpreti/Lotzbeck/image_processing_data/labels/Label__Lotzbeck_4__hasan__v2.geojson",
                    178416618,
                ),
            ]
        },
        "HofosOldershausen": {
            "Breitenbach": [
                (
                    "/mnt/nas/gis_data/customers/HofosOldershausen/Breitenbach/image_processing_data/labels/Label__Breitenbach__luca__v3.geojson",
                    274396774,
                )
            ]
        },
        "ToeringJettenbach": {
            # 'Inning':      [('/mnt/nas/gis_data/customers/ToeringJettenbach/Inning/image_processing_data/labels/Label__Seefeld_Inning_2_1__v2.geojson', 2102553528)], # There is no done point, we cannot convert it with the bboxes version
            "Jettenbach": [
                (
                    "/mnt/nas/gis_data/customers/ToeringJettenbach/Jettenbach/image_processing_data/labels/Label__Jettenbach_12__2021_08_02-07_19_122__v3.geojson",
                    1162362491,
                ),
                (
                    "/mnt/nas/gis_data/customers/ToeringJettenbach/Jettenbach/image_processing_data/labels/Label__Jettenbach_14__54mm__867mm__2021_08_24-11_47_48__v2.geojson",
                    2029944054,
                ),
                (
                    "/mnt/nas/gis_data/customers/ToeringJettenbach/Jettenbach/image_processing_data/labels/Label__Jettenbach_1__2021_08_02-07_21_17__v2.geojson",
                    1905420721,
                ),
                (
                    "/mnt/nas/gis_data/customers/ToeringJettenbach/Jettenbach/image_processing_data/labels/Label__Jettenbach_3__2021_08_02-07_18_55__v3.geojson",
                    41921502,
                ),
                (
                    "/mnt/nas/gis_data/customers/ToeringJettenbach/Jettenbach/image_processing_data/labels/Label__Jettenbach_5__58mm__932mm__2021_08_24-11_45_44__v2.geojson",
                    1310343500,
                ),
                (
                    "/mnt/nas/gis_data/customers/ToeringJettenbach/Jettenbach/image_processing_data/labels/Label__Jettenbach_7__58mm__932mm__2021_08_24-11_46_49__v2.geojson",
                    1338409446,
                ),
                (
                    "/mnt/nas/gis_data/customers/ToeringJettenbach/Jettenbach/image_processing_data/labels/Label__Jettenbach_8__2021_08_04-08_51_43__v2.geojson",
                    657043355,
                ),
            ],
            # 'Mischenried': [('/mnt/nas/gis_data/customers/ToeringJettenbach/Mischenried/image_processing_data/labels/Label__Mischenried__v2.geojson', 840858045)], # There is no done point, we cannot convert it with the bboxes version
            "Winhoering": [
                (
                    "/mnt/nas/gis_data/customers/ToeringJettenbach/Winhoering/image_processing_data/labels/Label__Winhoering_1____v4.geojson",
                    1965064980,
                ),
                (
                    "/mnt/nas/gis_data/customers/ToeringJettenbach/Winhoering/image_processing_data/labels/Label__Winhoering_2____v4.geojson",
                    629165559,
                ),
                (
                    "/mnt/nas/gis_data/customers/ToeringJettenbach/Winhoering/image_processing_data/labels/Label__Winhoering_3____v4.geojson",
                    1162882951,
                ),
            ],
        },
        "VonPfuel": {
            "Tuessling": [
                (
                    "/mnt/nas/gis_data/customers/VonPfuel/Tuessling/image_processing_data/labels/Label__Tuessling_1__Christian__v3.geojson",
                    982951984,
                )
            ]
        },
        "Wallerstein": {
            "Dist_12_13": [
                (
                    "/mnt/nas/gis_data/customers/Wallerstein/Dist_12_13/image_processing_data/labels/Label__Dist_12_13__winter__v2.geojson",
                    993280764,
                )
            ]
        },
        ...
        for region in label_last[customer]:
            for url_tuple in label_last[customer][region]:
                (
                    ...
                    url_tuple,
                    id_label_session_iter,
                    id_label_iter,
                    id_label_feature_iter,
                )
