...
def pick_all_geojson():
    label_last = {
        "ArenbergMeppen": {
            "Engelbertswald": [
                (
                    "\\\\192.168.37.4\\gis_data\\customers\\ArenbergMeppen\\Engelbertswald\\image_processing_data\\labels\\Label__ArenbergMeppen__Engelbertswald__2021_10_26__Hasan__v1_TRAININGLABELS.geojson",
                    1442470281,
                )
            ]
        },
        "Blauwald": {
            "Duttenstein": [
                (
                    "\\\\192.168.37.4\\gis_data\\customers\\Blauwald\\Duttenstein\\image_processing_data\\labels\\Label__Duttenstein__david__v1.geojson",
                    1514098108,
                ),
                (
        ...
        "GrafSpreti": {
            "Lotzbeck": [
                (
                    "\\\\192.168.37.4\\gis_data\\customers\\GrafSpreti\\Lotzbeck\\image_processing_data\\labels\\Label__Lotzbeck_1__luca__v1.geojson",
                    1257217749,
                ),
                (
        ...
        "Wallerstein": {
            "Dist_12_13": [
                (
                    "\\\\192.168.37.4\\gis_data\\customers\\Wallerstein\\Dist_12_13\\image_processing_data\\labels\\Label__Dist_12_13__winter__v2.geojson",
                    993280764,
                )
            ]
        },
