...
def compare_2_files(URL_1, URL_2):
    ...
    if counter_1 == 0 and counter_2 == 0:
        ...
        if counter_1 == len(tile_list_1) and counter_2 == len(tile_list_2):
            ...
            print(
                "They are different files but there is an intersection. ",
                len(tile_list_1) - counter_1,
                " is the number of intersection tiles. Number of tile in the firs and second file: ",
                len(tile_list_1),
                "|",
                len(tile_list_2),
            )
