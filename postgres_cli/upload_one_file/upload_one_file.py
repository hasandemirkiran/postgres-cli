import argparse
from postgres_cli.upload_one_file.upload_geoJson_file.upload_geoJson_file import main_geoJson
...
def main_upload_file():
    ...
    group.add_argument('--ortho', action='store_true', help="To upload ortho file formatted as .gpkg or .tif.")
