...
engine = create_engine('postgresql://ocell:PdUfpcWSYh4y3Cg@labeldb.cxitxpc33tur.eu-central-1.rds.amazonaws.com:5432/hasan_test_no_fk')
...
label_table_gdf.to_sql('label', engine, if_exists='append', index=False, dtype={'label_area_EPSG4326': Geometry('POINT', srid= 4326), 'label_area_EPSG3857': Geometry('POINT', srid= 4326)})
